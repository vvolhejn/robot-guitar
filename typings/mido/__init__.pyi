...
# mido has a nonstandard way of adding functions to the module
# so these didn't get auto-generated
def open_input(
...
def get_input_names(**kwargs: dict) -> list[str]: ...
def get_output_names(**kwargs: dict) -> list[str]: ...
