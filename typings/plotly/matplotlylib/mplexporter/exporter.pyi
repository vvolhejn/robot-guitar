...
class Exporter:
    ...
    @staticmethod
    def process_transform(transform, ax=..., data=..., return_trans=..., force_trans=...): # -> tuple[str, ndarray[Any, Any] | Any, Any | Transform | BlendedGenericTransform] | tuple[str, ndarray[Any, Any] | Any] | tuple[str, Any | Transform | BlendedGenericTransform] | str:
