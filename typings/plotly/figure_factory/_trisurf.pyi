...
def trisurf(x, y, z, simplices, show_colorbar, edges_color, scale, colormap=..., color_func=..., plot_edges=..., x_edge=..., y_edge=..., z_edge=..., facecolor=...): # -> list[Mesh3d | Scatter3d | Any] | list[Mesh3d] | list[Mesh3d | Scatter3d]:
    """
