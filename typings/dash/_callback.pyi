...
def callback(*_args, background=..., interval=..., progress=..., progress_default=..., running=..., cancel=..., manager=..., cache_args_to_ignore=..., **_kwargs): # -> Callable[..., Any]:
    """
...
def insert_callback(callback_list, callback_map, config_prevent_initial_callbacks, output, outputs_indices, inputs, state, inputs_state_indices, prevent_initial_call, long=..., manager=..., running=..., dynamic_creator=..., no_output=...): # -> str | LiteralString:
    ...

def register_callback(callback_list, callback_map, config_prevent_initial_callbacks, *_args, **_kwargs): # -> Callable[..., Any]:
    ...
