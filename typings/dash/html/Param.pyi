...
class Param(Component):
    ...
    _type = ...
    @_explicitize_args
    def __init__(self, children=..., id=..., n_clicks=..., n_clicks_timestamp=..., disable_n_clicks=..., key=..., name=..., value=..., accessKey=..., className=..., contentEditable=..., dir=..., draggable=..., hidden=..., lang=..., role=..., spellCheck=..., style=..., tabIndex=..., title=..., loading_state=..., **kwargs) -> None:
        ...
